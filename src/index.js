...
export const mockIntl = {
  formatDate: () => 'intl.formatDate (mock)',
  formatHTMLMessage: () => 'intl.formatHTMLMessage() (mock)',
  formatMessage: () => 'intl.formatMessage() (mock)',
  formatNumber: () => 'intl.formatNumber() (mock)',
  formatPlural: () => 'intl.formatPlural() (mock)',
  formatTime: () => 'intl.formatTime() (mock)',
  formatRelative: () => 'intl.formatRelative() (mock)',
  now: () => 'intl.now() (mock)',
};
